<!-- ========================= Content of Penelitian ========================== -->

<section class="header my-5">
    <h4 class="text-center">PUBLIKASI PENELITIAN
        <?= !empty($data['penelitian']) ? $data['penelitian'][0]['nama_fakultas'] : '' ?>
    </h4>
</section>
...
<section class="body container mb-5">
    ...
    <?php else: ?>
        <div class="alert alert-info text-center">
            Belum ada data publikasi penelitian untuk fakultas ini.
        </div>
    <?php endif; ?>
</section>
<!-- ========================= End of Content ============================== -->