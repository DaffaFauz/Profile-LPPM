...
<head>
    ...
    <title>Login | LPPM MU</title>

    <meta name="description" content="" />
    <meta name="title" content="Login | LPPM MU" />

    <!-- Favicon -->
    <!-- <link rel="icon" type="image/x-icon" href="<?php //ASSETS_URL ?>back/img/favicon/favicon.ico" /> -->
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= ASSETS_URL ?>back/vendor/css/pages/page-auth.css" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-6">
                            <a href="<?= BASE_URL ?>/Login" class="app-brand-link">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold">LPPM MU | Login</span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <form id="formAuthentication" class="mb-4" action="<?= BASE_URL ?>/Login/login" method="POST">
    ...
    <!-- Page JS -->
    <script src="<?= ASSETS_URL ?>back/js/pages-auth.js"></script>
</body>
